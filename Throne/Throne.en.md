...
### 🔵 Proxy
> Blocked and foreign resources (AI, social networks, video hostings) that are forced to open through your VPN tunnel.

<details>
<summary><b>👀 Click to expand the list (Proxy)</b></summary>
...
### 🔴 Block / Reject
> These sites are strictly blocked at the program level. This includes known tracking trackers, metrics, OS and smartphone telemetry, as well as ad networks. This saves your traffic and speeds up page loading.

<details>
<summary><b>👀 Click to expand the list (Block)</b></summary>
