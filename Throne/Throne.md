...
### 🔵 Прокси (Proxy)
> Заблокированные и зарубежные ресурсы (нейросети, соцсети, видеохостинги), которые принудительно открываются через ваш VPN-туннель.

<details>
<summary><b>👀 Нажмите, чтобы развернуть список (Proxy)</b></summary>
...
> Эти сайты жестко блокируются на уровне самой программы. Сюда включены известные трекеры слежки, метрики, телеметрия ОС и смартфонов, а также рекламные сети. Это экономит ваш трафик и ускоряет загрузку страниц.

<details>
<summary><b>👀 Нажмите, чтобы развернуть список (Block)</b></summary>
